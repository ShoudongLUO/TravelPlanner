...
export async function POST(request: NextRequest) {
  ...
  const { departure_city, destination, start_date, days, budget, travelers, content, youtube_videos } = body

  if (!departure_city || !destination || !start_date || !days || !budget || !travelers || !content) {
